...
<head>
    ...
    <!-- Module Styles -->
    <?php $__currentLoopData = \App\Services\Module\ModuleFacade::allStyles(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <link rel="stylesheet" href="/modules/styles/<?php echo e($name); ?>">
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

    <?php echo app('Illuminate\Foundation\Vite')('resources/scripts/main.js'); ?>
</head>

<body
    class="h-full overflow-hidden bg-gray-100 font-base
    <?php if(isset($current_theme)): ?> theme-<?php echo e($current_theme); ?> <?php else: ?> theme-<?php echo e(get_app_setting('admin_portal_theme') ?? 'invoiceshelf'); ?> <?php endif; ?> ">

    <!-- Module Scripts -->
    <?php $__currentLoopData = \App\Services\Module\ModuleFacade::allScripts(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $path): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/InvoiceShelf/resources/views/app.blade.php ENDPATH**/ ?>